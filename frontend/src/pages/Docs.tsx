...
export default function Docs() {
  const [activeSection, setActiveSection] = useState("getting-started-introduction");
    ...
    <div className="min-h-screen bg-[#0a0b0f] flex">
      ...
      <main className="flex-1 lg:ml-72">
        <div ref={contentRef} className="max-w-4xl mx-auto px-6 py-12">
          ...
          <section id="getting-started-introduction" data-section className="mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500">Learn how to install and use Boilerplate CLI</p>
              </div>
            </div>

            <P>
              Boilerplate (bp) is a CLI tool that lets developers save and reuse file or project templates, 
              including automated setup commands, to quickly generate code structures and eliminate repetitive work.
            </P>
          ...
          <section id="getting-started-installation" data-section className="mb-16">
            <SectionHeading id="installation">Installation</SectionHeading>

            <SubHeading>Using Homebrew (macOS)</SubHeading>
            <P>The recommended way to install Boilerplate on macOS:</P>
            <CodeBlock code={`brew tap ukhirani/bp
brew install bp`} />

            <SubHeading>Linux</SubHeading>
            <P>Install using the install script:</P>
            <CodeBlock code={`curl -fsSL https://raw.githubusercontent.com/ukhirani/boilerplate/main/install.sh | sh`} />

            <SubHeading>Using Go</SubHeading>
            <P>If you have Go installed:</P>
            <CodeBlock code={`go install github.com/ukhirani/boilerplate/bp@latest`} />
...
bp add ./my-project --name react-app`} />
            ...
            <CodeBlock code={`# Generate with default name
bp gen go-starter
...
bp ls`} />
          ...
          <section id="usage-adding-templates" data-section className="mb-16">
            <SectionHeading id="adding-templates">Adding Templates</SectionHeading>

            <P>Save files or directories as reusable templates:</P>

            <CodeBlock code={`# Add a file with its filename as template name
bp add main.cpp
...
bp add ./my-react-app --name react-template`} />
          ...
          <section id="usage-generating-code" data-section className="mb-16">
            <SectionHeading id="generating-code">Generating Code</SectionHeading>
...
bp gen <template-name> --dir ./src/components`} />
            ...
            <CodeBlock code={`# Generate a Go file
...
bp gen react-component --dir ./src/components`} />
          ...
          <section id="usage-previewing" data-section className="mb-16">
            <SectionHeading id="previewing">Previewing Templates</SectionHeading>

            <P>Preview template contents before generating:</P>

            <CodeBlock code={`# Preview template content
...
bp preview <template-name> --config`} />
            ...
            <P>
              The <code className="text-blue-400">--config</code> flag shows additional metadata including pre/post commands.
            </P>
          </section>
          ...
          <section id="usage-configuration" data-section className="mb-16">
            ...
            <CodeBlock code={`# Open config in default editor (VS Code)
...
bp config <template-name> -e nano`} />
          ...
          <section id="bp-hub-overview" data-section className="mb-16">
            ...
            <SectionHeading id="bp-hub-overview-heading">Overview</SectionHeading>

            <P>
              BP Hub is the community platform for sharing and discovering templates. Browse templates created by 
              other developers, clone them to your local machine, and share your own creations with the world.
            </P>
          ...
          <section id="bp-hub-cloning-templates" data-section className="mb-16">
            <SectionHeading id="cloning-templates">Cloning Templates</SectionHeading>

            <P>Clone templates from BP Hub to your local machine:</P>

            <CodeBlock code={`# Clone a template
...
bp clone <username>/<template-name> --alias my-template`} />
            ...
            <CodeBlock code={`# Clone the cpp template from umanghirani
...
bp gen cpp-starter`} />
          ...
          <section id="bp-hub-sharing-templates" data-section className="mb-16">
            <SectionHeading id="sharing-templates">Sharing Templates</SectionHeading>

            <P>
              To share templates on BP Hub, visit the web platform and create an account. You can then add 
              templates through the web interface, including file templates with code or directory templates 
          ...
          <section id="advanced-pre-post-commands" data-section className="mb-16">
            ...
            <SectionHeading id="pre-post-commands">Pre & Post Commands</SectionHeading>

            <P>
              Templates can include commands that run automatically before and after code generation. 
              This is useful for installing dependencies, formatting code, or running build scripts.
            </P>
...
PostCmd = ["npm install", "npm run format"]`}
          ...
          <section id="advanced-template-structure" data-section className="mb-16">
            <SectionHeading id="template-structure">Template Structure</SectionHeading>

            <P>Templates are stored in your home directory:</P>

            <CodeBlock code={`$HOME/boilerplate/templates/
├── react-component/
...
└── ...`} />
          ...
          <section id="advanced-toml-config" data-section className="mb-16">
            ...
            <P>Each template has a TOML configuration file with the following structure:</P>
...
PostCmd = ["npm run format"]`}
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody className="text-gray-300">
                  <tr className="border-b border-gray-800">
                    <td className="px-4 py-3"><code className="text-blue-400">Name</code></td>
                    <td className="px-4 py-3">string</td>
                    <td className="px-4 py-3">Template identifier</td>
                  </tr>
                  <tr className="border-b border-gray-800">
                    <td className="px-4 py-3"><code className="text-blue-400">IsDir</code></td>
                    <td className="px-4 py-3">boolean</td>
                    <td className="px-4 py-3">True for directory templates</td>
                  </tr>
                  <tr className="border-b border-gray-800">
                    <td className="px-4 py-3"><code className="text-blue-400">PreCmd</code></td>
                    <td className="px-4 py-3">string[]</td>
                    <td className="px-4 py-3">Commands to run before generation</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3"><code className="text-blue-400">PostCmd</code></td>
                    <td className="px-4 py-3">string[]</td>
                    <td className="px-4 py-3">Commands to run after generation</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="troubleshooting-common-issues" data-section className="mb-16">
            ...
            <CodeBlock code={`# Add Go bin to your PATH
...
export PATH=$PATH:/opt/homebrew/bin`} />
            ...
            <CodeBlock code={`# Fix permissions on templates directory
          ...
          <section id="troubleshooting-faq" data-section className="mb-16">
            ...
            <div className="space-y-6">
              <div>
                ...
                <P>Templates are stored in <code className="text-blue-400">$HOME/boilerplate/templates/</code></P>
              </div>

              <div>
                <SubHeading>Can I use bp without an account?</SubHeading>
                <P>
                  Yes! The CLI works completely offline for local templates. You only need an account to 
                  use BP Hub features like cloning and sharing templates.
                </P>
              </div>
...
go install github.com/ukhirani/boilerplate/bp@latest`} />
              ...
              <div>
                ...
                <P>
                  Yes, simply backup the <code className="text-blue-400">~/boilerplate/templates/</code> directory. 
                  You can also version control it with Git.
                </P>
              </div>
              ...
              <div>
                ...
                <P>
                  Any file type! Boilerplate doesn't process file contents - it simply copies them. 
                  You can template any programming language, config format, or binary file.
                </P>
              </div>
            </div>
          </section>
