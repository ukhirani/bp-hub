...
func SetTemplateHandler(client *firestore.Client, ctx context.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Assuming ID, TemplateType, Cmd types are defined elsewhere
		...
		fmt.Println("Random template added to 'templates' collection.")
